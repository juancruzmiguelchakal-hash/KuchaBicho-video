        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-heading font-bold text-foreground mb-3">Compromiso</h3>
              <p className="text-foreground/70">Garantizamos resultados efectivos en cada trabajo que realizamos.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-heading font-bold text-foreground mb-3">Cercanía</h3>
              <p className="text-foreground/70">Atención personalizada y trato directo con cada cliente.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-foreground/70">Productos aprobados y técnicas de última generación.</p>
            </div>
          </div>
        </div>
      </section>
