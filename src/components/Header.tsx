  ...
  return (
    <header 
      className={`fixed top-0 w-full z-40 transition-all duration-300 ${
        isScrolled ? 'bg-background/95 backdrop-blur-lg shadow-lg border-b border-border/50' : 'bg-transparent'
      }`}
    >
...
            />
            <div>
              <span className="text-2xl font-heading font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-yellow-300 block leading-none">
                Kuchabicho
              </span>
              <span className="text-xs text-foreground/60">Control de Plagas</span>
            </div>
          </Link>
