    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary/20 border border-primary/40 rounded-full text-sm font-semibold text-primary mb-6">
          ...
          <div className="flex flex-wrap gap-8 mt-12 pt-8 border-t border-border/30">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-foreground">Atención 24/7</div>
