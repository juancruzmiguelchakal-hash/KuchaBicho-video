        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className={`pt-2 sm:pt-4 lg:pt-0 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              }} className="bg-[#25D366] text-white px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:bg-[#20BA5C] hover:scale-105 hover:shadow-lg flex items-center justify-center gap-2">
